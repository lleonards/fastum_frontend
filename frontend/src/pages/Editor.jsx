              ...
              >
                ...
                <div className="glass-card p-4">
                  ...
                  <div className="relative" ref={fontDropdownRef}>
                    ...
                    {fontDropdownOpen && (
                      <div className="absolute z-50 top-full left-0 right-0 mt-1 rounded-xl overflow-hidden shadow-2xl border border-white/20"
                           style={{ background: '#1a1a2e', maxHeight: '280px', overflowY: 'auto' }}>
                        {FONTS.map(f => (
                          <button
                            key={f.value}
                            type="button"

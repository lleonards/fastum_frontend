        ...
        <AnimatePresence mode="wait">
          {!opened ? (
            <motion.div
              ...
              onClick={() => setOpened(true)}
            >
              {/* Tampa do presente - usa ribbonColor como base */}
              <div
                className="relative rounded-t-lg py-5 px-6 text-center overflow-hidden"
                style={{
                  background: `linear-gradient(135deg, ${ribbonColor}cc 0%, ${ribbonColor}99 100%)`,
                  boxShadow: `0 -4px 15px ${ribbonColor}40`,
                }}
              >
              ...
              <div
                ...
                style={{
                  background: `linear-gradient(135deg, ${ribbonColor}bb 0%, ${ribbonColor}88 100%)`,
            ...
            <motion.div key="gift-open">
              ...
              <motion.div
                ...
                style={{ background: `linear-gradient(135deg, ${ribbonColor}cc 0%, ${ribbonColor}99 100%)` }}
              >

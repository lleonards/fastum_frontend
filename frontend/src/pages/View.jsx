  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-10"
      ...
      <AnimatePresence mode="wait">
        ...
        {phase === 'opening' && (
          <motion.div key="opening" className="relative" style={{ width: '100%', maxWidth: 520 }}>
            {/* Envelope de baixo */}
            <div
              className="relative rounded-b-lg mx-auto"
              style={{ background: envColor, height: 220, maxWidth: 420 }}
            >
    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-10"
      ...
      <AnimatePresence mode="wait">
        ...
        {phase === 'shaking' && (
          ...
          >
            <div className="relative rounded-t-2xl py-8 px-6" style={{ background: 'linear-gradient(135deg, #c0392b, #e74c3c)' }}>
            ...
            <div className="rounded-b-2xl py-10" style={{ background: 'linear-gradient(135deg, #a93226, #c0392b)' }}>
        ...
        {phase === 'opening' && (
          <motion.div key="opening" style={{ width: '100%', maxWidth: 400 }} className="mx-auto">
            {/* Tampa voando */}
            <motion.div
              ...
              style={{ background: 'linear-gradient(135deg, #c0392b, #e74c3c)', maxWidth: 260 }}
            >
...
export default function View() {
  ...
  const fetchMessage = async () => {
    try {
      ...
      setMessage(data)
      const sortedPhotos = (data.message_photos || []).sort((a, b) => a.order_index - b.order_index)
  ...
  return (
    <>
      ...
      {/* Rodapé discreto */}
      <div className="fixed bottom-3 right-4 text-white/15 text-xs pointer-events-none">
        MensagemMágica ✦
      </div>
